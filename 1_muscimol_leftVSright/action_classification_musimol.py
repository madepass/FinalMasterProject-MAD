...
#%% 
os.chdir('D:\\ub_neuroComp\\dancause_data\\processing\\1_musimol_leftVSright\\export')
#%% general info

subjects = [1,2]
mat_names = ['','subject1_pre','subject1_post']
...
for i_sub in subjects:
    ...
    ts_tmp = sio.loadmat(mat_names[i_sub])['dataSorted'] # [N,T,n_trials,motiv]   
